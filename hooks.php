<?php
define ('SS_ksf_data_dictionary', 111<<8);
 ...
 *
 * ***********************************************************************************/
class hooks_ksf_data_dictionary extends hooks {
	var $module_name = 'ksf_data_dictionary'; 
	...
	*/
	...
	{
		$security_sections[SS_ksf_data_dictionary] = _("ksf_data_dictionary");

		$security_areas['SA_ksf_data_dictionary'] = array(SS_ksf_data_dictionary|101, _("ksf_data_dictionary"));

		return array($security_areas, $security_sections);
	}
	function db_postwrite(&$cart, $trans_type)
	{
		//display_notification( "ksf_data_dictionary hooks was told about " . $trans_type );
